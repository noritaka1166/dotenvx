...
t.test('#--help shows armor advanced command', ct => {
  ...
  ct.match(output, /Professional Security:[\s\S]*keychain\s+⌥ move private keys into local macOS Keychain[\s\S]*armor\s+⛨ move private keys into Dotenvx Armor \[www\.dotenvx\.com\/armor\]/, 'professional security commands include armor')
